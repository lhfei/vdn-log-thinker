 ...
 * @since Mar 20, 2015
 */
public class VideologGroupLocalDriver extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		String input = "src/test/resources/input/videolog/0000.txt";
		...
		int exitCode = ToolRunner.run(new VideologGroupLocalDriver(), args);
