...
public final class VideologFilter {
	...
	public static Set<String> VALID_ERR_CODE = new TreeSet<String>(
			Arrays.asList("208000", "303000", "301010", "301020", "301030", "601000", "602000"));
	...
	public static boolean contains(String errId){
		return VALID_ERR_CODE.contains(errId);
	}
